...
initial_training_count = 10  # Number of trianing samples to collect for first model training
max_training_count = 20  # Maximum number of training samples to collect for training
batch_size = 5  # Number of molecules to simulate in each iteration of active learning loop
